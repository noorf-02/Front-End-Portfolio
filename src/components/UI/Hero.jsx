...
export default function Hero() {
  return (
    <div className="wrapper text-white">
      <motion.div initial={{opacity:0,x:-50}} whileInView={{opacity:1,x:0}} viewport={{once:true}} transition={{duration:0.4}} className="hero h-[70vh] flex flex-col justify-center">
